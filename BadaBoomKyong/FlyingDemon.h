...
{
public:
    FlyingDemon(GameObject* _owner);
    virtual ~FlyingDemon()override;
private:
    //Range
    BulletFactory* m_pBulletFactory = nullptr;
    ObjectPool<FlyingDemonFireBall, 30>* m_pFireBallPool = nullptr;
...
public:
    static constexpr const char* FlyingDemonTypeName = "FlyingDemon";
